/**
 * Shared model proxy for the Image Analysis app.
 *
 ...
 *
 * The cost of the convenience: every image analysed through this Worker passes
 ...
 * the body would put patient images into your log tail.
 *
  ...
  async fetch(request, env) {
    ...
    if (request.method !== 'GET') {
      ...
      if (body.byteLength > MAX_BODY_BYTES)
        return fail(413, 'That image is too large for the shared service.', request, env)
    }
