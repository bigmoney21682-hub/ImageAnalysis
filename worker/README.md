...
their own key. No image touches any server you run in that case, which for
medical images is a deliberate property and not an accident of the
architecture.

This Worker gives that up for everyone who has no key of their own. Every image
...
- **413** — the request body is over 12 MB. Not a photo of a study.
