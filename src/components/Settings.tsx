        ...
        {provider?.needsKey && (
          <>
            ...
            <p className="field__help field__help--warn">
              ...
              browser. Restrict it by referrer where the provider supports it, and rotate it if
              you share this device.
            </p>
            <p className="field__help field__help--warn">
              A free-tier AI Studio key lets Google use your prompts and images to improve their
              models. A paid key does not. Read the terms before uploading anything from a real
              patient.
            </p>
            ...
            <label className="field">
              ...
              <input
                ...
                placeholder="https://imageanalysis-proxy.you.workers.dev"
                autoComplete="off"
                autoCorrect="off"
                autoCapitalize="off"
                spellCheck={false}
              ...
              <span className="field__help">
                ...
                shared operator. Used only when the key above is missing or exhausted. Every image
              ...
              <label className="field field--check">
                ...
                <span>
                  ...
                  <span className="field__help">
                    ...
                    pays for — so it is rate limited, and every image passes through their server.
                    A key of your own is used first and the shared pool only picks up when yours
                    is exhausted. Untick this to guarantee no image leaves this browser except to
                    Google.
                  </span>
                </span>
              </label>
