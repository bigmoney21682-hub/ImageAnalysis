...
interface Props {
  /** The image the report was made from. Null disables the whole panel. */
...
const SUGGESTIONS = [
  'Which of these could be artifact rather than real pathology?',
  'Walk me through how you ruled the differentials in and out.',
  'What would a repeat or a second view actually add?',
  'What would I expect to see if this were the alternative diagnosis?',
]
...
export function Chat({
  ...
  return (
    <section className="chat" aria-label="Follow-up questions">
      <h2 className="chat__head">Ask about this image</h2>
