 ...
 *      directly — no image touches a server we run, which for medical imaging
 ...
 *      Every image sent this way travels through whoever runs that Worker.
 ...
 * entirely, which is the setting to use if no image may leave the browser
 ...
 */
const SHARED_PROXY_URL = 'https://imageanalysis-proxy.bigmoney21682.workers.dev'
const SHARED_PROXY_TOKEN = ''

const KEY_URL = 'img.proxy.url'
const KEY_TOKEN = 'img.proxy.token'
const KEY_SHARED_OFF = 'img.proxy.shared-off'
