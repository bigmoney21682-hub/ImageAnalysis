 ...
 * talks straight to Google with the user's own key, and no image ever touches
 * a server we run. Filling this in trades that property for a link that works
 * without each visitor supplying a key. See worker/README.md.
 */
