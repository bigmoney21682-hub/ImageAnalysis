 ...
 * selectable.
 *
 * Note this ranks differently from a throughput-oriented app: subtle low-
 * contrast findings reward the strongest available vision reasoning, so Pro
 * outranks Flash here even though Flash has the roomier free quota.
 */
